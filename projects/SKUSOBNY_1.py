...
if __name__ == "__main__":
    ...
    # --------------------------------------------------------
    start_2d = np.array([0.5, 0.5])   # (x, z)
    end_2d   = np.array([1.5, 1.0])   # (x, z)
...
'''
Použil som 2DOF robota pohybujúceho sa v rovine XZ. 
Medzi počiatočným a koncovým bodom som vygeneroval trajektóriu pomocou lineárnej interpolácie 
cez viac ako 50 bodov. Pre každý bod trajektórie som vypočítal inverse kinematics, 
teda uhly kĺbov robota. Tieto uhly som nastavil robotu a tým som simuloval jeho pohyb po trajektórii. 
Nakoniec som vykreslil požadovanú a skutočnú trajektóriu robota.
'''